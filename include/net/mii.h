...
/* MASTER-SLAVE Control Register (100BASE T-2 and 1000BASE-T Control Register)
 * bit definitions
 */
#define MII_ADVERTISE_1000_FULL BIT(9) /** Advertise 1000BASE-T full duplex */
#define MII_ADVERTISE_1000_HALF BIT(8) /** Advertise 1000BASE-T half duplex */

/* MASTER-SLAVE Status Register (100BASE T-2 and 1000BASE-T Status Register)
 * bit definitions
 */
#define MII_LP_ADVERTISE_1000_FULL BIT(11) /** LP supt 1000BASE-T full duplex */
#define MII_LP_ADVERTISE_1000_HALF BIT(10) /** LP supt 1000BASE-T half duplex */

/* Extended Status Register (ESTAT) bit definitions */
